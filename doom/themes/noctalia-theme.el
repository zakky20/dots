...
(let* ((bg "#1a1b26")
      ...
      (outline-color "#5e70be")
      (outline-variant "#344382")
      (primary "#7aa2f7")
      (primary-container "#013198")
      (secondary "#bb9af7")
      (secondary-container "#370495")
      (shadow "#000000")
      (surface "#1a1b26")
      (surface-container "#262838")
      (surface-container-high "#2d2e41")
      (surface-container-highest "#33354a")
      (surface-container-low "#20212f")
      (surface-container-lowest "#1a1b26")
      (surface-variant "#242635")
      (tertiary "#9ece6a")
      (tertiary-container "#4e7b1e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#9ece6a")
      (on-success "#000000")
      (success-container "#4e7b1e")
      (on-success-container "#ffffff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#7aa2f7")
      (primary-fixed-dim "#013198")
      (secondary-fixed "#bb9af7")
      (secondary-fixed-dim "#370495")
      (tertiary-fixed "#9ece6a")
      (tertiary-fixed-dim "#4e7b1e")
