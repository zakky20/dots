...
def init_widgets_list():
    widgets_list = [
        ...
        widget.CurrentLayout(
                 ...
                 mode = "both",
                 icon_first = True,
                 custom_icon_paths = [f"/home/zak/.config/qtile/assets/layout/"],
                 scale = 0.45,
                 padding = 5,
        ),
        widget.TextBox(
        ...
        widget.GenPollText(
                 update_interval = 10,
                 func = lambda: subprocess.check_output("/usr/local/bin/music", shell=True, text=True).strip(),
        ...
        widget.GenPollText(
                 update_interval = 60,
                 func = lambda: subprocess.check_output("/usr/local/bin/up", shell=True, text=True).strip(),
                 background = colors[10],
                 foreground = colors[6],
                 padding = 3,
                 fmt = '  {}',
...
# Bars
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), margin=[15, 75, 8, 75], size=33)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), margin=[15, 75, 8, 75], size=33)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), margin=[15, 75, 8, 75], size=33))]
